...
{
    /*
     * The Campaign class manages the campaign data.
     * It stores a JSON string containing campaign details in the static variable `$campaigns`.
     * The `campaignData()` method decodes this JSON string into an associative array and returns it.
     * This class is used to provide campaign-related information for bidding or other processes.
     */
    ...
    public static function campaignData()
    {
        return json_decode(self::$campaigns,true);
    }
}