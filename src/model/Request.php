...
{
    /*
     * The Request class handles the bid request data.
     * It stores a JSON string containing details of the bid request in the static `$request` variable.
     * The `bidRequestData()` method decodes the JSON string into an associative array and returns it.
     * This class provides access to various details like impression, device, app, user, and geo data for processing bids.
     */
        ...
        "imp": [
            {
                ...
                "metric": [
                    ...
                    {"type": "viewability", "value": 0.98, "vendor": "EXCHANGE"}
                ],
                "ext": {
    ...
    public static function bidRequestData()
    {
